;(function (window) {
  ...
  //文本框，写下自己想要的祝福语 ---cn
  let texts = ['ส่งถึง', 'คุณลิส', 'ผมสร้างสิ่งนี้มาให้', 'เพราะอยากจะ', 'บอกว่า', 'ตัวคุณลิส', 'มีแสงสว่างที่','สวยงาม', 
  'และ', 'น่ารักเสมอ', 'ต่อจากนี้', 'ก็เป็นแสงสว่าง','ที่สวยงามแบบนี้', 'ตลอดไปเลยนะ']
